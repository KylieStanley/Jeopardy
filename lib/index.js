...
gameBoard.addEventListener('click', openQuestion)
...
function openQuestion() {
  //display a card with the question and an input field for the answer
  //grab the li, check the class of the ul parent and point value of self
  //match against the game.questions array. display question.question
}
